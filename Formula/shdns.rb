...
class Shdns < Formula
  desc "Port of ChinaDNS (DNS filter) in golang with IPv6 support"
  homepage "https://github.com/domosekai/shdns"
  url "https://github.com/domosekai/shdns/archive/v0.8.4.tar.gz"
  sha256 "01be102d4d971598c77864f87328631392c1890416a5a36c26cdbdc4470a8837"
